            ...
            for field in ['is_staff', 'is_admin', 'is_email_verified', 'is_nin_verified', 'is_bvn_verified', 'is_business_cac_verified', 'is_kyc_verified']:
                if field in data:
                    raise serializers.ValidationError(
                        f"Only superadmin can edit the '{field}' field.")
...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        access_token_expiration = current_time + \
        ...
        data['refresh_token_expires_at'] = refresh_token_expiration.strftime(
            '%d-%m-%Y %H:%M:%S')
        data['access_token_expires_at'] = access_token_expiration.strftime(
            '%d-%m-%Y %H:%M:%S')
...
class MerchantRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'middle_name', 'business_name',
                  'bvn', 'email', 'phone', 'password', 'confirm_password']
