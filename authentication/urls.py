...
urlpatterns = [
    ...
    path('verify-email/',
         MerchantViewSet.as_view({'post': 'verify_email'}), name='verify-email'),
    path('signin/',
         MerchantViewSet.as_view({'post': 'signin'}), name='merchant-signin'),
    path('token/refresh/', TokenRefreshView.as_view(), name='token-refresh'),
    path('merchants/<uuid:merchant_id>/',
         MerchantViewSet.as_view({'get': 'retrieve'}))
