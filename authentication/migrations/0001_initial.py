    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='', max_length=50, validators=[django.core.validators.MinLengthValidator(2)])),
                ...
                ('bvn', models.CharField(blank=True, help_text='(Bank Verification Number)', max_length=30, null=True, unique=True)),
                ('is_bvn_verified', models.BooleanField(default=False)),
                ('cac_number', models.CharField(blank=True, help_text='(Corporate Affairs Commission)', max_length=30, null=True, unique=True)),
