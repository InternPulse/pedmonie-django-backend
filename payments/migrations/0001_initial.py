    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='merchant_gateways', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'MerchantPaymentGateway',
            },
        ),
    ]
